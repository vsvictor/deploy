...
class GetUserApiEndpoint : ProtectedHttpEndpoint() {
	...
	override fun implementSafeEndpoint (socketAddress: SocketAddress, request: HttpRequest) : HttpResponse {
		...
		responseJson.putOpt("expert", user.expert)
		responseJson.putOpt("confidentiality", user.confidentiality)
		...
		responseJson.put("isSubscribedToWeather", user.isSubscribedToWeather)
