...
public abstract class SetTalkEventStartDateApiMethod extends ProtectedAdminApiMethod {

	@Override protected String getName() { return "set_talk_event_start_date"; }
	...
	@Override protected HttpResponse implementProtectedApi(SocketAddress socketAddress, HttpRequest request) throws UnableToParse {
		...
		talkEvent.setStartDate(startDate);
