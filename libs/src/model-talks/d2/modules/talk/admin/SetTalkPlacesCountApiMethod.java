...
public abstract class SetTalkPlacesCountApiMethod extends ProtectedAdminApiMethod {

	@Override protected String getName() { return "set_talk_places_count"; }
	...
	@Override protected HttpResponse implementProtectedApi(SocketAddress socketAddress, HttpRequest request) throws UnableToParse {
		...
		final Integer placesCount 	= requestJson.isNull("placesCount") ? null : requestJson.getInt("placesCount");

		final Talk talk = getTalksMapper(getStorage()).getItem(id);

		talk.setPlacesCount(placesCount);
