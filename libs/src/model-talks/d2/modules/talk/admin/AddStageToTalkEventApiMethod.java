...
public abstract class AddStageToTalkEventApiMethod extends ProtectedAdminApiMethod {

	@Override protected String getName() { return "add_stage_to_talk_event"; }
	...
	@Override protected HttpResponse implementProtectedApi(SocketAddress socketAddress, HttpRequest request) throws UnableToParse {
		...
		final String stageId = requestJson.getString("stageId");

		try {

			getTalkEventsMapper(getStorage()).getItem(talkEventId).addStage(stageId);
