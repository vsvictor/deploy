...
class ModifyIndividual  : ProtectedHttpEndpoint() {
    override val name = "modify_individual"
    ...
    override fun implementSafeEndpoint(socketAddress: SocketAddress, request: HttpRequest): HttpResponse {
        ...
        //val ev = IndividualEvent(userId, eventName,date, locationName, isApply)
        var ev : IndividualEvent
        try {
            ev = IndividualEvent.mapper.items.find { it -> it.uuid.equals(uuid)}
